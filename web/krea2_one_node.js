...
import { buildNodeUI } from "./js/ui.js?v=film-studio-28";

const styleId="krea2-one-node-style";
if(!document.getElementById(styleId)){
  const link=document.createElement("link");link.id=styleId;link.rel="stylesheet";link.href=`${new URL("./css/krea2_one_node.css",import.meta.url).href}?v=film-studio-28`;document.head.append(link);
}
